...
> Category: **Overview** · [KB Home](../../../../README.md) · [Source](https://library.tradingtechnologies.com/trade/overview/preferences/description-preferences/algos-autospreader-preferences/)
...
| Auto-launch OMA algos | Whether to launch [order-builder OMAs](https://library.tradingtechnologies.com/trade/oma-overview.html), such as the OCO 2 OMA, automatcally when the minimum number of required orders are added. This setting can be overridden on an individual basis by creating an OMA order template. |
