...
title: Managing tabs
category: Overview
source: https://library.tradingtechnologies.com/trade/overview/widgets/task-widgets/managing-tabs/
---

# Managing tabs

> Category: **Overview** · [Source](https://library.tradingtechnologies.com/trade/overview/widgets/task-widgets/managing-tabs/)
>
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/wgt-tab-menu.png)
...
* To add another row to the tab panel, select **Add tab row** from the context menu. Adding a row, moves the tabs hidden in the scrolling view to the next row.
  ...
  ![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/wgt-add-tab-row.png)
...
1. Right-click in the title bar of the widget group and select **Add tabs to group**.

   ![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/widget-group-add-tabs1.png)

   The tab appears at the bottom of the widget group.

   ![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/widget-group-add-tabs1a.png)
2. Right-click the widget group tab to rename, remove, or copy the tab as needed.

   ![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/widget-group-tabs.png)
3. To add and configure additional tabs for the group, click the **+** next to the widget group tab.
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/widget-group-tabs2.png)
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/wgt-tab-color.png)

←[Previous PostOpening a widget](opening-a-widget.md)

[Next PostCustomizing widget settings](customizing-widget-settings.md)→
