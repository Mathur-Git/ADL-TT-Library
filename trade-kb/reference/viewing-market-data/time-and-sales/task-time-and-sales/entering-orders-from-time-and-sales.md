---
title: Entering orders from Time and Sales
category: Viewing Market Data
source: https://library.tradingtechnologies.com/trade/viewing-market-data/time-and-sales/task-time-and-sales/entering-orders-from-time-and-sales/
---
...
1. Click the price or quantity for a trade.

   The floating order entry widget opens seeded with the selected price or quantity.

   ![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/ts-order-entry.png)
2. Configure the order parameters in either MD Trader or the Order Ticket and submit the order.

←[Previous PostLaunching widgets from Time & Sales](launching-widgets-from-time-sales.md)
