---
title: Creating a Synthetic Spread
category: Spread Trading
source: https://library.tradingtechnologies.com/trade/spread-trading/autospreader/task-autospreader/creating-a-synthetic-spread/
---
...
To create a synthetic spread:

1. Click **Create** in the Autospreader widget.
2. Set the following spread definition parameters:
...
4. For each leg, configure the following settings:
   ...
   * [Ratio](../description-autospreader/spread-configuration.md#ratio)
...
[Next PostEditing a Synthetic Spread](editing-a-synthetic-spread.md)→
