---
title: Autospreader rules configuration
category: Spread Trading
source: https://library.tradingtechnologies.com/trade/spread-trading/autospreader-rules/description-autospreader-rules/autospreader-rules-configuration/
---
...
←[Previous PostAutospreader rules configuration interface](autospreader-rules-configuration-interface.md)

[Next PostAutospreader rules configuration Logic](autospreader-rules-configuration-logic.md)→
