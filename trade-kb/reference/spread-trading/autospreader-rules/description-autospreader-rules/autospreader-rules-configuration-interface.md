---
title: Autospreader rules configuration interface
category: Spread Trading
source: https://library.tradingtechnologies.com/trade/spread-trading/autospreader-rules/description-autospreader-rules/autospreader-rules-configuration-interface/
---
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/auto-create-rule-desc.png)
...
←[Previous PostAutospreader rules configuration Custom Variable](autospreader-rules-configuration-custom-variable.md)

[Next PostAutospreader rules configuration](autospreader-rules-configuration.md)→
