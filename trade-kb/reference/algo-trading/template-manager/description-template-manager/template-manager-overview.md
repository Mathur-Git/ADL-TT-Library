---
title: Template Manager overview
category: Algo Trading
source: https://library.tradingtechnologies.com/trade/algo-trading/template-manager/description-template-manager/template-manager-overview/
---
...
Template Manager shows all of your deployed algos, available public algos and algos that are not currently deployed.

![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/tm-display.png)

1. Algo Explorer pane: Lists algos associated with the user, along with templates defined for the algos
2. Algo parameters pane: Shows parameters for the selected algo template
3. Template management controls: Performs actions for selected algos or templates
