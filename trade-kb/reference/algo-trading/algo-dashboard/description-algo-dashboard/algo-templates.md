...
source: https://library.tradingtechnologies.com/trade/algo-trading/algo-dashboard/description-algo-dashboard/algo-templates/
---

# Algo templates

> Category: **Algo Trading** · [Source](https://library.tradingtechnologies.com/trade/algo-trading/algo-dashboard/description-algo-dashboard/algo-templates/)
>
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/alg-algo-templates.png)

You can create algo templates with the Algo Dashboard and [Autotrader](algo-templates.md) widgets. Additionally, you can use algo templates created with either widget.
...
←[Previous PostAlgo dashboard panes](algo-dashboard-panes.md)

[Next PostAlgo instance names](algo-instance-names.md)→
