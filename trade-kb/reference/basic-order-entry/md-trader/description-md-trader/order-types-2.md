...
source: https://library.tradingtechnologies.com/trade/basic-order-entry/md-trader/description-md-trader/order-types-2/
---

# Order Types

> Category: **Basic Order Entry** · [Source](https://library.tradingtechnologies.com/trade/basic-order-entry/md-trader/description-md-trader/order-types-2/)
>
> **Interpreted in:** [Order Types & Execution § The ADL bridge](../../../../guides/order-types-and-execution.md#the-adl-bridge) · [Order Types & Execution § Native order types](../../../../guides/order-types-and-execution.md#native-order-types)
...
connected to supports cross trades. To submit a cross order, refer to [Submitting Cross Orders](../../order-ticket/task-order-ticket/submitting-a-cross-trade.md).
...
←[Previous PostExchange-specific functionality in MD Trader](exchange-specific-functionality-in-md-trader.md)

[Next PostKeyboard trading in MD Trader](keyboard-trading-in-md-trader.md)→
