---
title: Moving Average Deviation
category: Analytics
source: https://library.tradingtechnologies.com/trade/analytics/charts/technical-indicators/moving-average-deviation/
---

# Moving Average Deviation

> Category: **Analytics** · [KB Home](../../../../README.md) · [Source](https://library.tradingtechnologies.com/trade/analytics/charts/technical-indicators/moving-average-deviation/)

The Moving Average Deviation indicator…

![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/moving-average-deviation.png)

## Configuration Options

![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/moving-average-deviation-1.png)
...
* **Moving Average Type**: Type of moving average to use in the calculations:
  ...
  * Double Exponential
  * Triple Exponential
* **Points or Precent**: TBD
* **Color Selectors**: Colors to use for graph elements.
* **Display Axis Label**: Whether to display the most recent value on the Y axis.

←[Previous PostCoppock Curve (CC)](coppock-curve-cc.md)

[Next PostDetrended Price Oscillator (DPO)](detrended-price-oscillator-dpo.md)→
