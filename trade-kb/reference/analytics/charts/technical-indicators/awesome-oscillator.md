...
category: Analytics
source: https://library.tradingtechnologies.com/trade/analytics/charts/technical-indicators/awesome-oscillator/
---
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/awesome-oscillator.png)

## Configuration Options

![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/awesome-oscillator-1.png)
...
\[ AO = SMA\\_{5-periods}(\frac {(High + Low)}{2}) – SMA\_{34-periods}(\frac {(High + Low)}{2}) \]

←[Previous PostBollinger Bandwidth](bollinger-bandwidth.md)

[Next PostAbsolute Price Oscillator](absolute-price-oscillator.md)→
