...
title: STARC Bands
category: Analytics
source: https://library.tradingtechnologies.com/trade/analytics/charts/technical-indicators/starc-bands/
---
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/starc-bands.png)

## Configuration Options

![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/starc-bands-1.png)

* **Period**: Number of bars to use in the calculations.
* **MA Period**: Number of periods to use for calculating the moving average.
* **Multiplier**: Moving average multipler to define the distance to draw the bands away from the ATR.
...
←[Previous PostIntraday Momentum Index (IMI)](intraday-momentum-index-imi.md)

[Next PostKeltner Channel (KC)](keltner-channel-kc.md)→
