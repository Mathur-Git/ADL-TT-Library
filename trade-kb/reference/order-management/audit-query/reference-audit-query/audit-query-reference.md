---
title: Audit Query reference
category: Order Management
source: https://library.tradingtechnologies.com/trade/order-management/audit-query/reference-audit-query/audit-query-reference/
---

# Audit Query reference

> Category: **Order Management** · [KB Home](../../../../README.md) · [Source](https://library.tradingtechnologies.com/trade/order-management/audit-query/reference-audit-query/audit-query-reference/)

## Available settings

These settings affect only the selected Audit Query widget. To update the default settings with these value for newly-opened Audit Trail widgets, or to apply them to existing opened widgets, click **Defaults**.

![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/at-settings.png)
...
The Audit Query widget includes the same columns as the Audit Trail widget.

### Filtering columns

If a column is filterable, a drop-down arrow appears when you hover on the column header.

![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/filter1.png)

To filter the column, click the arrow to select one or more values and click **OK**.

![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/filter2.png)
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/filter3.png)
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/filter4.png)
...
![](https://library.tradingtechnologies.com/wp-content/uploads/2025/12/filter5.png)
