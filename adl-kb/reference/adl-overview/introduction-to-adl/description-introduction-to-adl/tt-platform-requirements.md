---
title: TT Platform requirements
category: adl-overview
source: https://library.tradingtechnologies.com/adl/adl-overview/introduction-to-adl/description-introduction-to-adl/tt-platform-requirements/
---

# TT Platform requirements

> Category: **ADL Overview, Concepts & Tutorials** · [Source](https://library.tradingtechnologies.com/adl/adl-overview/introduction-to-adl/description-introduction-to-adl/tt-platform-requirements/)
>
> **Interpreted in:** [Platform & Workspace § TT Desktop vs browser access vs mobile](../../../../../trade-kb/guides/platform-and-workspace.md#tt-desktop-vs-browser-access-vs-mobile)

### System requirements

To ensure the best experience, TT recommends the following setup on any machine you use to access the TT platform.
...
TT recommends a minimum of 4GB of RAM on any machine you use to access the TT platform.
...
←[Previous PostUsing ADL algos](using-adl-algos.md)

[Next PostIntroducing the new ADL canvas](introducing-the-new-adl-canvas.md)→
