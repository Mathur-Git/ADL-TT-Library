...
documentation — 132 pages — plus a hand-authored navigation layer built on top of it.
...
This KB is the sibling of **[trade-kb](../trade-kb/README.md)** — the Trade platform documentation
...
adl-kb/
├── README.md                 this file
├── INDEX.md                  all 132 pages, grouped
...
└── reference/                verbatim mirror, URL structure preserved
    ├── adl-overview/         concepts, tutorials, advanced topics  (67)
    ├── trading-blocks/       (10)   discrete-blocks/     (14)
    ├── arithmetic-blocks/    (9)    miscellaneous-blocks/ (9)
    ├── logic-blocks/         (7)    group-blocks/        (4)
    ├── virtualized-blocks/   (4)    library-blocks/      (3)
    ├── jump-blocks/          (3)    basic-blocks/        (2)
```

Every `reference/` page carries YAML front matter (`title`, `category`, `source`) and links back to its
original URL. Inter-page links have been rewritten to local relative paths — **472 verified internal
links**, all resolving.
...
links to the reference page that supports it.
